...
conn = ibm_db.connect("database=bludb;hostname=98538591-7217-4024-b027-8baa776ffad1.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud; port=30875; uid = jld10087;password = SLoXDBeDOo7hji4F;security =SSL;sslcertificate = DigiCertGlobalRootCA.crt ","","")
print(conn)
